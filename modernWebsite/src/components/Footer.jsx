...
const Footer = () => {
    return (
        <>
            <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20 font-['Founders_Grotesk_X'] ">

                <div className="w-1/2  flex flex-col justify-between h-full">
                    <div className="heading">
                        <h1 className='text-[8vw] uppercase leading-none -mb-10 font-semibold'>Eye-</h1>
                        <h1 className='text-[8vw] uppercase leading-tight -mb-10 font-semibold'>Opening</h1>
                    </div>
                ...
                <div className="w-1/2">
                    ...
                    <h1 className='text-[8vw] uppercase leading-none -mb-10 font-semibold'>Presentations
                    </h1>
