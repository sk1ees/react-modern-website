...
const Marquee = () => {
    ...
    return (
        <>
            <div data-scroll data-scroll-section data-scroll-speed=".1" className="cursor-[url(https://cdn.custom-cursor.com/db/4906/32/arrow2786.png),_pointer] w-full py-20 rounded-tl-3xl rounded-tr-3xl bg-[#004D43]">
